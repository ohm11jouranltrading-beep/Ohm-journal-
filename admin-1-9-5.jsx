...
const CSS=`
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .glass-gold{
    background:linear-gradient(135deg,#241505,#160e04);
    backdrop-filter:blur(6px);
    -webkit-backdrop-filter:blur(6px);
  ...
  return(
    <div style={{position:"relative",width:size,height:size}}>
      <svg width={size} height={size}>
        {arcs.map((a,i)=><path key={i} d={a.d} fill={a.color} stroke="#0d0904" strokeWidth="2.5"/>)}
        <circle cx={cx} cy={cy} r={r*0.56} fill="#0d0904"/>
      </svg>
...
function PerfTable({title,rows,icon}){
  ...
  return(
    <div style={{background:"#120d08",backdropFilter:"blur(6px)",WebkitBackdropFilter:"blur(6px)",border:"1px solid rgba(255,255,255,0.09)",borderRadius:18,padding:"20px 22px",boxShadow:"0 8px 32px rgba(0,0,0,0.25)",transition:"transform .4s cubic-bezier(.4,0,.2,1),box-shadow .4s ease,border-color .4s ease",overflowX:"auto"}}>
  ...
  return(
    <div style={{minHeight:"100vh",background:"#0C0A08",color:"#fff",fontFamily:"'Outfit',sans-serif",direction:"rtl",position:"relative"}}>
      ...
      <div style={{display:"flex",gap:10,background:"rgba(0,0,0,0.35)",borderBottom:"1px solid rgba(255,255,255,0.05)",padding:"14px 28px",overflowX:"auto",position:"relative",zIndex:1}}>
        {[
          {id:"overview",label:"Overview",color:"#F59E0B",icon:<svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M4 20V11M12 20V4M20 20v-8" stroke="currentColor" strokeWidth="2.8" strokeLinecap="round" strokeLinejoin="round"/></svg>},
          {id:"trades",label:`Trades (${c.count})`,color:"#FCD34D",icon:<svg width="14" height="14" viewBox="0 0 24 24" fill="none"><rect x="5" y="3" width="14" height="18" rx="2.5" stroke="currentColor" strokeWidth="2.2"/><path d="M9 8.5h6M9 12.5h6M9 16.5h3" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"/></svg>},
          {id:"analysis",label:"Analysis",color:"#FB923C",icon:<svg width="14" height="14" viewBox="0 0 24 24" fill="none"><circle cx="10.5" cy="10.5" r="6.5" stroke="currentColor" strokeWidth="2.4"/><path d="M20 20l-4.4-4.4" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round"/></svg>},
          {id:"psychology",label:"Psychology",color:"#D97706",icon:<svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M9.5 3.5A3.5 3.5 0 0 0 6 7v.6a2.6 2.6 0 0 0-.8 4.9v1a3.5 3.5 0 0 0 3.5 3.5H9M14.5 3.5A3.5 3.5 0 0 1 18 7v.6a2.6 2.6 0 0 1 .8 4.9v1a3.5 3.5 0 0 1-3.5 3.5H15M9.5 3.5v13M14.5 3.5v13" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round"/></svg>},
      ...
      <div style={{padding:"24px 28px 60px",position:"relative",zIndex:1}}>
        ...
        {tab==="overview"&&(()=>{
          ...
          <div style={{display:"flex",flexDirection:"column",gap:16}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"1.6fr 1fr",gap:16}}>
              <div style={{background:"#0d0904",backdropFilter:"blur(8px)",border:"1px solid rgba(255,255,255,0.07)",borderRadius:20,padding:"20px 22px",position:"relative",overflow:"hidden"}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16}}>
              <div style={{background:"#0d0904",backdropFilter:"blur(8px)",border:"1px solid rgba(255,255,255,0.07)",borderRadius:20,padding:"20px 22px",display:"flex",gap:18,alignItems:"center",position:"relative",overflow:"hidden"}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16}}>
              <div style={{background:"#0d0904",backdropFilter:"blur(8px)",border:"1px solid rgba(255,255,255,0.07)",borderRadius:20,padding:"20px 22px"}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"1.3fr 1fr",gap:16}}>
              {Object.keys(c.sessions||{}).length>0&&(
                <div style={{background:"#120d08",backdropFilter:"blur(6px)",WebkitBackdropFilter:"blur(6px)",border:"1px solid rgba(255,255,255,0.09)",borderRadius:18,padding:"20px 22px",boxShadow:"0 8px 32px rgba(0,0,0,0.25)",transition:"transform .4s cubic-bezier(.4,0,.2,1),box-shadow .4s ease,border-color .4s ease"}}>
        ...
        {tab==="trades"&&(
          <div>
            ...
            {/* header row */}
            <div style={{display:"grid",gridTemplateColumns:"4px 1fr 80px 80px 70px 70px",gap:12,padding:"8px 16px",marginBottom:6}}>
            ...
            <div style={{display:"flex",flexDirection:"column",gap:8}}>
              ...
              {sorted.map((t,i)=>{
                ...
                return(
                  <div key={i} className="row-hover stat-glass" onClick={()=>setTradeSel(t)}
                    style={{display:"grid",gridTemplateColumns:"4px 1fr 80px 80px 70px 70px",gap:12,padding:"14px 16px",alignItems:"center",cursor:"pointer",animation:`fadeUp .4s cubic-bezier(.34,1.56,.64,1) ${Math.min(i*0.03,0.6)}s both`,borderColor:`${gc}22`}}>
                    <div style={{width:4,height:32,borderRadius:4,background:`linear-gradient(180deg,${gc},${gc}40)`,boxShadow:`0 0 10px ${gc}90`}}/>
                    <div style={{display:"flex",alignItems:"center",gap:10}}>
                      <div style={{width:34,height:34,borderRadius:10,background:`${isW?"#10b981":"#ef4444"}14`,border:`1px solid ${isW?"#10b981":"#ef4444"}30`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:14,flexShrink:0}}>{t.direction==="L"?"▲":"▼"}</div>
                      <div>
                    ...
                    <p style={{fontSize:15,fontWeight:900,color:isW?"#10b981":"#ef4444",fontFamily:"'JetBrains Mono',monospace",textAlign:"center",textShadow:`0 0 12px ${isW?"#10b98160":"#ef444460"}`}}>{isW?"+":""}${t.pnl}</p>
                    <p style={{fontSize:13,color:"#f59e0b",fontFamily:"'JetBrains Mono',monospace",textAlign:"center"}}>{t.rr||0}:1</p>
                    <div style={{display:"flex",justifyContent:"center"}}>
                      {t.grade?<span style={{background:`${gc}18`,color:gc,border:`1px solid ${gc}35`,borderRadius:6,padding:"2px 8px",fontSize:12,fontWeight:800,boxShadow:`0 0 8px ${gc}30`}}>{t.grade}</span>:<span style={{color:"rgba(255,255,255,0.2)",fontSize:12}}>—</span>}
                    </div>
        ...
        {tab==="psychology"&&(()=>{
          ...
          <div style={{display:"flex",flexDirection:"column",gap:16}}>
            ...
            {/* ── WHOOP RINGS ROW ── */}
            <div style={{background:"#0d0904",backdropFilter:"blur(8px)",border:"1px solid rgba(255,255,255,0.06)",borderRadius:24,padding:"24px",position:"relative",overflow:"hidden"}}>
  ...
  return(
    <div style={{minHeight:"100vh",background:"#0C0A08",color:"#fff",fontFamily:"'Outfit',sans-serif",direction:"rtl",position:"relative"}}>
      ...
      <div style={{padding:"16px 28px",background:"rgba(0,0,0,0.3)",borderBottom:"1px solid rgba(255,255,255,0.04)",display:"flex",gap:10,alignItems:"center",flexWrap:"wrap",position:"relative",zIndex:1}}>
        ...
        <div style={{display:"flex",gap:6}}>
          {[
            ...
            <button key={k} className="btn-hover" onClick={()=>setSort(k)}
              style={{display:"flex",alignItems:"center",gap:6,background:sort===k?"linear-gradient(135deg,rgba(217,119,6,0.28),#150f08)":"#120d08",color:sort===k?"#FCD34D":"rgba(255,255,255,0.4)",border:`1px solid ${sort===k?"rgba(217,119,6,0.4)":"rgba(255,255,255,0.08)"}`,borderRadius:10,padding:"8px 15px",fontSize:12,fontWeight:700,letterSpacing:".02em",fontFamily:"inherit",whiteSpace:"nowrap"}}>
        ...
        <div style={{display:"flex",gap:4}}>
          {[
            ...
            <button key={v} className="btn-hover" onClick={()=>setView(v)} style={{display:"flex",alignItems:"center",justifyContent:"center",background:view===v?"linear-gradient(135deg,rgba(217,119,6,0.28),#150f08)":"#120d08",color:view===v?"#FCD34D":"rgba(255,255,255,0.35)",border:`1px solid ${view===v?"rgba(217,119,6,0.4)":"rgba(255,255,255,0.08)"}`,borderRadius:10,padding:"8px 12px",fontFamily:"inherit"}}>
              {ic}
            </button>
          ))}
          <button className="btn-hover" onClick={loadClients} style={{display:"flex",alignItems:"center",justifyContent:"center",background:"#120d08",color:"rgba(255,255,255,0.4)",border:"1px solid rgba(255,255,255,0.08)",borderRadius:10,padding:"8px 12px",fontFamily:"inherit"}}>
      ...
      <div style={{padding:"20px 28px 80px",position:"relative",zIndex:1}}>
            ...
            {filtered.map((c,idx)=>{
              ...
              return(
                <div key={c.uid} className="card-hover glow-pulse" onClick={()=>setSelected(c)}
                  style={{"--glow":`${sc}45`,background:"#120d08",backgroundImage:`radial-gradient(circle at 15% 10%,${sc}0c,transparent 55%)`,backdropFilter:"blur(6px)",WebkitBackdropFilter:"blur(6px)",border:`1px solid ${sc}2e`,borderRadius:20,padding:"20px",overflow:"hidden",position:"relative",animation:`fadeUp .35s ease ${idx*0.04}s both`}}>
        ...
        {/* LIST */}
        {view==="list"&&(
          <div style={{background:"#120d08",backdropFilter:"blur(6px)",WebkitBackdropFilter:"blur(6px)",border:"1px solid rgba(255,255,255,0.07)",borderRadius:18,overflow:"hidden",boxShadow:"0 12px 40px rgba(0,0,0,0.3)"}}>
