  ...
  return (
    <GlassCard animKey={state.animKey}>
      ...
      <div className="item d3" style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:18}}>
        ...
        <button onClick={doResetPassword} disabled={loading} style={{background:'none',border:'none',cursor:'pointer',fontSize:12,color:'rgba(74,222,128,.65)',fontFamily:"'DM Sans',sans-serif",fontWeight:600}}>
          نسيت كلمة المرور؟
        </button>
      </div>
      {resetSent && (
        <div className="item" style={{marginBottom:14,padding:'10px 13px',background:'rgba(34,197,94,.08)',borderRadius:10,border:'1px solid rgba(34,197,94,.22)',textAlign:'center'}}>
          <p style={{fontSize:12,color:'#4ade80',fontWeight:600}}>✅ تم إرسال رابط الاستعادة إلى بريدك</p>
        </div>
      )}
